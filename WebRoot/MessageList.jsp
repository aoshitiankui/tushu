...
<head>
    ...
    <script src="<%=request.getContextPath() %>/MessageList.js"></script>
          ...
          <div class="col-md-12">
              <section class="panel">
                ...
                <div class="panel-body">
                   <form name="MessageForm" id="MessageForm" role="form">
                   	   <!--  开始 -->
                       ...
                       <div class="form-group col-md-6 col-lg-6">
                           <div class="col-md-2 col-lg-2"></div>
                           <label for="exampleInputPassword1" class="col-md-2 col-lg-2 control-label" >是否已处理：</label>
                           <div class="col-md-4 col-lg-4">
	                           <t:seledata  styleclass="form-control"  code="isdeal" name="isdeal" />
                           </div>
                          <div class="col-md-4 col-lg-4"></div>
                       </div>
                       <!--  结束 -->
                       ...
                       <div class="form-group col-md-6 col-lg-6">
                           ...
                           <div class="col-md-4 col-lg-4">
	                           <input type="text" class="form-control" name="name" data-bv-stringLength data-bv-stringLength-min='0' data-bv-stringLength-max='40'>  
                           </div>
                          <div class="col-md-4 col-lg-4"></div>
                       </div>
                       <!--  开始 -->
                       <div class="form-group col-md-6 col-lg-6">
                           <div class="col-md-2 col-lg-2"></div>
                           <label for="exampleInputPassword1" class="col-md-2 col-lg-2 control-label" >留言类型：</label>
                           <div class="col-md-4 col-lg-4">
	                           <t:seledata  styleclass="form-control"  code="mestype" name="mtype" />
                           </div>
                          <div class="col-md-4 col-lg-4"></div>
                       </div>
                       <!--  结束 -->
                       ...
                       <div class="form-group col-md-6 col-lg-6">
                           <div class="col-md-2 col-lg-2"></div>
                           <label for="exampleInputPassword1" class="col-md-2 col-lg-2 control-label" >IP地址：</label>
                           <div class="col-md-4 col-lg-4">
	                           <input type="text" class="form-control" name="ipaddress" data-bv-stringLength data-bv-stringLength-min='0' data-bv-stringLength-max='40'>  
                           </div>
                          <div class="col-md-4 col-lg-4"></div>
                       </div>
                       <!--  开始 -->
                       <div class="form-group col-md-6 col-lg-6">
                           <div class="col-md-2 col-lg-2"></div>
                           <label for="exampleInputPassword1" class="col-md-2 col-lg-2 control-label" >主题：</label>
                           <div class="col-md-4 col-lg-4">
	                           <input type="text" class="form-control" name="title" data-bv-stringLength data-bv-stringLength-min='0' data-bv-stringLength-max='40'>  
                           </div>
                          <div class="col-md-4 col-lg-4"></div>
                       </div>
                       <!--  开始 -->
		...
		<div class="row">
 		...
 		<div class="row">
 		   <div class="col-md-12">
				...
				<div class="modal fade" id="MessageModal" style="z-index:2030;" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">  
				    <div class="modal-dialog">  
				        <div class="modal-content">  
